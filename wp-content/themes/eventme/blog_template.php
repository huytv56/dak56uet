...
?>        
        ...
        <?php }else{ ?>
            <section class="page-section image blog-head">
                <div class="container text-center">
                    <h1 class="section-title">
                        <?php echo __('Tiêu đề Blog', TEXT_DOMAIN); ?>
                    </h1>
                </div>
            </section>
        <?php } ?>
                    ...
                    <section id="content" class="content col-sm-8 col-md-9">
                    	...
                    	<?php 
			 			...
			 			<?php if ( $a->have_posts() ) : while ( $a->have_posts() ) : $a->the_post(); ?>
			 				<article id="post-<?php the_ID(); ?>" <?php post_class('post-wrap thumbnail'); ?>  >
			 			...
			 			<?php endwhile; else: ?>
							<p><?php _e('Xin lỗi. Không tìm thấy nội dung bạn cần.', TEXT_DOMAIN); ?></p>
						<?php endif; ?>
