...
$args = array(
    'name' => sprintf( __( 'Sidebar phải', TEXT_DOMAIN) ),
    'id' => "sidebar-right",
    'description' => __( 'Sidebar phải', TEXT_DOMAIN ),
    'class' => '',
...
function ova_register_menus() {
  register_nav_menus( array(
    'primary'   => __( 'Menu phụ', TEXT_DOMAIN ),
    'one_page'   => __( 'Menu chính', TEXT_DOMAIN ),
  ) );
}
         ...
         <section class="comment-details">
             <div class="comment-meta commentmetadata clearfix media-body author-name">
              ...
              <div class="comment-body clearfix comment-content">
                  <?php comment_text() ?>
                  <div class="pull-left">
                    <?php edit_comment_link(__('(Sửa)', TEXT_DOMAIN),'  ','') ?>
          ...
          <?php if ($comment->comment_approved == '0') : ?>
             <em><?php _e('Bình luận của bạn đang đợi duyệt', TEXT_DOMAIN) ?></em>
             <br />
          <?php endif; ?>
...
function ajax_action_stuff() {
  ...
  $content = '<strong>'.__('Tên').' :'.$name.'<br/>'.__('SDT: ').': '. $phone . '</strong><br/>'. $message;
